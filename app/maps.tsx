...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: "700", backgroundColor: "#fff", paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 6, elevation: 3 },
});