...
export default function MyReportDetailsScreen() {
  ...
  const handleShare = () => {
    if (!report) return;
    Share.share({
      message: `${report.title} — ${report.location}. Reported on Hamro Issue.`,
    });
  };
  ...
  const doneCount = getDoneCount(report.status);
  ...
  return (
    ...
    >
      ...
      <Image source={report.image} style={styles.heroImage} />
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.sectionLabel}>COMMUNITY RESPONSE</Text>
